...
//  проверка соответствуют ли значения в keeper ожидаемым при создании одной игры
...
// работает ли функция получения всех функций как создалась игра 1
...
// игра с плохо отформатированным вводом
...
//  проверка соответствуют ли значения в keeper ожидаемым при создании третьей игры
...
// работает ли функция получения всех функций как создалась игра 3
